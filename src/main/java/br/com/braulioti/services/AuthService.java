...
import br.com.braulioti.data.dto.security.TokenDTO;
import br.com.braulioti.exception.RequiredObjectsNullException;
import br.com.braulioti.model.User;
import br.com.braulioti.repositoriy.UserRepository;
import br.com.braulioti.security.jwt.JWTTokenProvider;
...
public class AuthService {
    ...
    public AccountCredentialsDTO create(AccountCredentialsDTO user) {
        if (user == null) throw new RequiredObjectsNullException();
